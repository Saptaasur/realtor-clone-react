        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
            <p className='mb-6'>Have an account?
              <Link to="/SignIn" className="text-red-400 hover:text-red-800 transition duration-200 ease-in-out ml-1">Sign In</Link>
          ...
          <button type="submit" className="w-full bg-blue-600 text-white px-7 py-3 text-sm font font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800">Sign Up</button>
