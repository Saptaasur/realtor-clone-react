    ...
    <main className="max-w-md px-2 mx-auto">
       ...
       <form onSubmit={onSubmit}>
        ...
        <div className="flex mb-6">
          ...
          <button type="submit" className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase shadow-md hover:bg-blue-800 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out rounded-lg">Create Listing</button>
       </form>
        </main>
  )
}
